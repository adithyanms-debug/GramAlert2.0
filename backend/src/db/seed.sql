...
('villager', '$2b$10$T2osgnVy53WxAymA1x.8E.eAti3Hg2mBxriVoYdX.j.KToeOKS4nK', 'villager@example.com', '1234567890');
...
INSERT INTO admins (username, password, email, phone, role, department, division, created_by_superadmin_id) VALUES
('admin', '$2b$10$T2osgnVy53WxAymA1x.8E.eAti3Hg2mBxriVoYdX.j.KToeOKS4nK', 'admin@example.com', '1234567890', 'ADMIN', 'Public Works', 'Maintenance', 1);
