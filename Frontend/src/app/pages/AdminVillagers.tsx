      ...
      >
        ...
        <div className="p-8 rounded-xl bg-white/70 backdrop-blur-sm border border-white/60 shadow-lg">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-800">Villagers</h1>
              <p className="text-slate-600">Manage registered villagers and their accounts</p>
            </div>
          </div>
          <p className="text-slate-600">This page is under construction. User management coming soon!</p>
        </div>
      </motion.div>
    </div>
  );
